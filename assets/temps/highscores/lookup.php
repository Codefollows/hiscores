<?php
	...
	if ($user == null) {
		...
		echo '<div class="page-btns text-center">
				<div class="skill-title">Statistics for <span class="text-info">'.ucwords($username).'</span></div>
				<a target="_blank" href="card.php?user='.(str_replace(" ", "_", $username)).'" class="btn btn-default next">View Playercard</a>
			  </div>';
?>
